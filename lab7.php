    ...
    <div class="container">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($nama && $tanggal_lahir && $pekerjaan_key) {
                ...
                $daftar_gaji = [
                    'programmer' => ['nama' => 'Programmer', 'gaji' => 'Rp 30.000.000'],
                    'designer' => ['nama' => 'Designer Grafis', 'gaji' => 'Rp 15.500.000'],
                    'manager' => ['nama' => 'Manager Proyek', 'gaji' => 'Rp 20.000.000'],
                    'guru' => ['nama' => 'Guru Sekolah', 'gaji' => 'Rp 10.000.000']
                ];
